...
#pragma warning restore 618
        ...
        public static async Task SaveAsync(Player player)
        {
            ...
            try
            {
                // An admin panel edit queued a reload for this player: the in-memory
                // home is stale and must not overwrite the newer database row.
                if (Resources.Players.DiscardSave(player.Home.Id)) return;
